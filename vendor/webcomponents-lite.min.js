...
!function () {
  ...
  function e(e) {
    ...
    var h = Node.prototype.cloneNode;i.cloneNode = function (e, t) {
      ...
      if (t.querySelectorAll) for (var n, o, i = t.querySelectorAll(r), a = e.querySelectorAll(r), s = 0, c = a.length; c > s; s++) {
  ...
  function t(e, t) {
    ...
    function n() {
      ...
      u.push(this), c++, n();
        ...
        d = s.length,
        l = [],
        u = [];if (d) for (var h, f = 0; d > f && (h = s[f]); f++) {
    ...
    if ("loading" === document.readyState) for (var e, t = document.querySelectorAll("link[rel=import]"), n = 0, o = t.length; o > n && (e = t[n]); n++) {
      d(e);
    }
  }()), t(function (e) {
  ...
  var t = e.xhr,
    ...
    this.cache = {}, this.onload = e, this.oncomplete = t, this.inflight = 0, this.pending = {};
      ...
      this.inflight += e.length;for (var t, n = 0, o = e.length; o > n && (t = e[n]); n++) {
        this.require(t);
      }this.checkDone();
      ...
      this.cache[e] = o;for (var i, a = this.pending[e], s = 0, c = a.length; c > s && (i = a[s]); s++) {
  ...
  var t = function t(e) {
    this.addCallback = e, this.mo = new MutationObserver(this.handler.bind(this));
      ...
      this.addCallback && this.addCallback(e);for (var t, n = 0, o = e.length; o > n && (t = e[n]); n++) {
  ...
  function t(e) {
    ...
    var t = e.ownerDocument.createElement("style");return t.textContent = e.textContent, a.resolveUrlsInStyle(t), t;
      ...
      var n = this,
        ...
        var r = !1;if (-1 == e.textContent.indexOf("@import")) r = !0;else if (e.sheet) {
          r = !0;for (var i, a = e.sheet.cssRules, s = a ? a.length : 0, c = 0; s > c && (i = a[c]); c++) {
      ...
      if (e && this._mayParse.indexOf(e) < 0) {
        this._mayParse.push(e);for (var o, r = e.querySelectorAll(this.parseSelectorsForNode(e)), i = 0, a = r.length; a > i && (o = r[i]); i++) {
  ...
  function t(e, t) {
    ...
    if (e = window.wrap(e), !(n.indexOf(e) >= 0)) {
      n.push(e);for (var o, r = e.querySelectorAll("link[rel=" + a + "]"), s = 0, c = r.length; c > s && (o = r[s]); s++) {
  ...
  function t(e, t) {
    ...
    E = !1;for (var e, t = L, n = 0, o = t.length; o > n && (e = t[n]); n++) {
      e();
    }L = [];
  }function a(e) {
    y ? r(function () {
